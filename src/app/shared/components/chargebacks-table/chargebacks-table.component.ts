...
export class ChargebacksTableComponent {
    ...
    columns = computed<Column2<StatChargeback>[]>(() =>
        runInInjectionContext(this.injector, () => [
            ...
            createCurrencyColumn(
                (d) => ({ amount: d.amount, code: d.currency_code.symbolic_code }),
                {
                    header: 'Amount',
                },
            ),
            ...
            },
            {
                ...
                cell: (d) => ({
                    ...
                    link: () =>
                        `/party/${d.party_id}/invoice/${d.invoice_id}/payment/${d.payment_id}`,
                }),
                hidden: this.onePayment(),
            },
            {
                field: 'created_at',
                cell: { type: 'datetime' },
            },
            createPartyColumn((d) => ({ id: d.party_id }), { hidden: this.onePayment() }),
